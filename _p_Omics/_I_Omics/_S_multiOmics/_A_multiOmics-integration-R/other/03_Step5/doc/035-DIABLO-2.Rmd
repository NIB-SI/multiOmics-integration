...
```{r}
write("Entering 035a !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!", "bla.log", append=TRUE)
```
...
```{r}
write("Mid diablo 1 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!", "bla.log", append=TRUE)
```
...
```
```{r}
write("Mid diablo 2 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!", "bla.log", append=TRUE)
```
...
```{r}
write("Mid diablo 3 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!", "bla.log", append=TRUE)
```
...
```{r}
write("Mid diablo 4 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!", "bla.log", append=TRUE)
```
...
write("Mid diablo network !!!!!!!!!!!!!!!!!", "bla.log", append=TRUE)
datasets <- names(CCDATA[-1])
ndatasets<- length(datasets)
write(datasets, "bla.log", append=TRUE)
...
write("Mid diablo network 2 !!!!!!!!!!!!!!!!!", "bla.log", append=TRUE)
...
```
```{r}
write("Mid diablo 4a !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!", "bla.log", append=TRUE)
```
```{r}
# treatment 1
e1 <- extractEdges2(N1)
...
```
```{r}
write("Mid diablo 4b !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!", "bla.log", append=TRUE)
```
```{r }
# treatment 2
.treat[2]
...
```{r}
write("End 035-DIABLO !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!", "bla.log", append=TRUE)
```
