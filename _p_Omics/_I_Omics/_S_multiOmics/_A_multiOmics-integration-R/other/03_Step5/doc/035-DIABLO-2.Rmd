...
Three datasets are organized as a list of matrices with same samples as rows and variables in columns.
...
```{r}
write("Variable plots", "bla.log", append=TRUE)
```
