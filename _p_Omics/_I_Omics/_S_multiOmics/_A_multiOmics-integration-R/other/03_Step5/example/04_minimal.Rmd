...
```{r}
hormonomics <- read.table("data_hormonomics.txt", header=TRUE, sep="\t")
metabolomics <- read.table("data_metabolomics.txt", header=TRUE, sep="\t")
qPCR <- read.table("data_qPCR.txt", header=TRUE, sep="\t")
```
