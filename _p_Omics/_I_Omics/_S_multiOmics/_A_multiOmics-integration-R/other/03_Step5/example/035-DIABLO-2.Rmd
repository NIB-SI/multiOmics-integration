...
```{r fig.width=8,fig.height=c(7,10)[1+(length(data)>4)]}
#plotVar(res, cutoff=0.5, legend = TRUE, overlap=!FALSE, style='graphics')
#plotVar(res, cutoff=0.5, legend = TRUE, overlap=FALSE, style='graphics')
plotVar(final.diablo.model, cutoff=0.5, legend = FALSE, comp=c(1,2), overlap=FALSE, col=rep(1,length(data)))
plotVar(final.diablo.model, cutoff=0.5, legend = FALSE, comp=c(2,3), overlap=FALSE, col=rep(1,length(data)))
```
