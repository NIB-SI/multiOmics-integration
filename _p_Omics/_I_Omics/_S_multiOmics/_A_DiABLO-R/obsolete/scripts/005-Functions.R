...
{
#
# Adaptation of original function mixOmics:::network
#
# 1. Only edges with weights above cutoff value will be kept in the final, returned network.
# 2. Possible to preserve node positions: 
#        previously defined/saved layout (e. g. from complete network) can be used for plot of reduced network.
# 
    arg.call = match.call()
    user.arg = names(arg.call)[-1]
    err = tryCatch(mget(names(formals()), sys.frame(sys.nframe())),
...
<!-- concordance:005-Functions.R:005-Functions.Rmd:1 1 5 10 1 1 3 4 1 1 5 20 1 1 2 1122 1 1 3 298 1 1 3 296 1 1 2 %
42 1 1 2 98 1 1 2 902 1 1 2 4 1 -->
